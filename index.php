...
<html>
	<head>
		<title>Awesomenauts by Karpinski</title>
		<link rel="stylesheet" type="text/css" media="screen" href="index.css">
		<!--<link rel="shortcut icon" href="Awesomenauts/favicon.ico">-->
	...
	<body>
		...
		<form id="input" method="post">
			...
			<div class="password">
				...
				<!--setting the input type to password prevents the actual characters from being visible on the screen-->
			</div>
		...
		<!--registers the buttons and input spaces on the page for the user to enter-->
		...
		//takes you to the main menu page whenever the indicated area is clicked on 
